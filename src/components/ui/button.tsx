  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white hover:opacity-90 shadow-comfort font-semibold",
        calm: "bg-primary-soft text-primary-foreground hover:bg-primary shadow-gentle",
        comfort: "bg-accent-soft text-accent-foreground hover:bg-accent shadow-warm",
        emergency: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-comfort animate-pulse",
      },
      size: {
